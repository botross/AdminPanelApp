                ...
                <Modal visible={visible} onDismiss={hideModal} contentContainerStyle={containerStyle}>
                    <View style={{ position: "relative" }}>
                        ...
                        <View style={{ display: "flex", flexDirection: "row", alignItems: "center" }}>
                            ...
                            <Text style={{ fontWeight: "600", fontSize: 16, marginLeft: 10 }}>{SingleOrder?.customer?.firstname}{"\n"}{SingleOrder?.customer?.lastname}</Text>
                        </View>
                        <View style={{ marginVertical: 15 }}>
                            <Text style={{ fontWeight: "600", fontSize: 20, color: "#00B27A", marginBottom: 2 }}>Indirizzo</Text>
                            <Text style={{ fontWeight: "400", fontSize: 16, color: "black", marginBottom: 8 }}>{SingleOrder?.customer?.billingAddress}</Text>
                            <Text style={{ fontWeight: "600", fontSize: 20, color: "#00B27A", marginBottom: 2 }}>Contatto</Text>
                            <Text style={{ fontWeight: "400", fontSize: 16, color: "black", marginBottom: 8 }}>{SingleOrder?.customer?.phoneNumber}</Text>
                            <Text style={{ fontWeight: "600", fontSize: 20, color: "#00B27A", marginBottom: 2 }}>Numero di products</Text>
                            <Text style={{ fontWeight: "400", fontSize: 16, color: "black", marginBottom: 8 }}>{SingleOrder?.products?.length}</Text>
                            <Text style={{ fontWeight: "600", fontSize: 20, color: "#00B27A", marginBottom: 2 }}>Orario</Text>
                            <Text style={{ fontWeight: "400", fontSize: 16, color: "black", marginBottom: 8 }}>{SingleOrder?.deliveryTime}</Text>
                        </View>
