...
const CompletedCard = ({Camp}) => {
    return (
        <View style={{
            ...
            backgroundColor: "white", borderRadius: 15, marginTop: 10
        }}>
            ...
            <View style={{ marginVertical: 10 }}>
                ...
                <Pressable style={{ width: "75%", height: 30, justifyContent: "center", alignItems: "center", borderRadius: 10, backgroundColor: "#00B27A", marginHorizontal: 10, alignSelf: "center" , marginTop:15}}>
                    <Text style={{ fontWeight: "500", fontSize: 14, color: "white", marginRight: 10 }}>Riattiva</Text>
                </Pressable>
