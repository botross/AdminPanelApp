        ...
        <Header navigation={navigation} title="Support" icon={require("../../assets/SupportIcon.png")} >
            <ScrollView style={{ marginBottom: 100 }}>
                ...
                <View style={{
                    ...
                    <View style={{ height: 60, width: "95%", alignSelf: "center", justifyContent: "center", paddingHorizontal: 20, backgroundColor: "#F6F6F6" }}>
                        <Text style={{ color: "#AEAEAE", fontSize: 16, fontWeight: "600" }}>Oggetto:<Text style={{ fontWeight: "600", fontSize: 16, color: "black", marginLeft: 20 }}>            Lorem Ipsum...</Text> </Text>
                    </View>
                    <View style={{ height: 60, width: "95%", alignSelf: "center", justifyContent: "center", paddingHorizontal: 20, backgroundColor: "white" }}>
                        <Text style={{ color: "#AEAEAE", fontSize: 16, fontWeight: "600" }}>Data:<Text style={{ fontWeight: "600", fontSize: 16, color: "black", marginLeft: 20 }}>                  31/03/2022</Text> </Text>
                    </View>
