...
const CreateMainCategorie = ({ navigation }) => {


    return (
        <Header navigation={navigation} title="Create Menu" icon={require("../../assets/ProdottiIcon.png")} >
            <View style={{ display: "flex", flexDirection: "row", alignItems: "center", alignSelf: "center" }}>
                ...
                <Text style={{ fontSize: 26, fontWeight: "700", color: "#00B27A", alignSelf: "center" }}>Crea un nuovo Menu</Text>
            </View>
...
export default CreateMainCategorie
